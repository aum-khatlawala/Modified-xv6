...
main(int argc, char *argv[])
{
  ...
  if(argc < 3){
   8:	4789                	li	a5,2
   a:	00a7dd63          	bge	a5,a0,24 <main+0x24>
   e:	86aa                	mv	a3,a0
  ...
  1e:	4881                	li	a7,0
  for (int i = 0; argv[1][i] != '\0'; i++) {
  20:	e785                	bnez	a5,48 <main+0x48>
  22:	a82d                	j	5c <main+0x5c>
    fprintf(2, "Usage: strace <mask> <command>\n");
  24:	00001597          	auipc	a1,0x1
  28:	8ac58593          	addi	a1,a1,-1876 # 8d0 <malloc+0xe8>
  2c:	4509                	li	a0,2
  2e:	00000097          	auipc	ra,0x0
  32:	6ce080e7          	jalr	1742(ra) # 6fc <fprintf>
    exit(1);
  36:	4505                	li	a0,1
  38:	00000097          	auipc	ra,0x0
  3c:	352080e7          	jalr	850(ra) # 38a <exit>
  for (int i = 0; argv[1][i] != '\0'; i++) {
  40:	0705                	addi	a4,a4,1
  42:	fff74783          	lbu	a5,-1(a4)
  46:	cb89                	beqz	a5,58 <main+0x58>
    if (argv[1][i] < '0' || argv[1][i] > '9') {
  48:	fd07879b          	addiw	a5,a5,-48
  4c:	0ff7f793          	andi	a5,a5,255
  50:	fef678e3          	bgeu	a2,a5,40 <main+0x40>
      num_flag = 0;
  54:	8846                	mv	a6,a7
  ...
  if (num_flag == 0) {
  58:	04080c63          	beqz	a6,b0 <main+0xb0>
  5c:	01058793          	addi	a5,a1,16
  60:	ef040713          	addi	a4,s0,-272
  64:	36f5                	addiw	a3,a3,-3
  66:	1682                	slli	a3,a3,0x20
  68:	9281                	srli	a3,a3,0x20
  6a:	068e                	slli	a3,a3,0x3
  6c:	96be                	add	a3,a3,a5
  6e:	10058593          	addi	a1,a1,256
  ...
  74:	e310                	sd	a2,0(a4)
  for (int i = 2; i < argc; i++) {
  76:	00d78663          	beq	a5,a3,82 <main+0x82>
    if (i == 32) {
  7a:	07a1                	addi	a5,a5,8
  7c:	0721                	addi	a4,a4,8
  7e:	feb79ae3          	bne	a5,a1,72 <main+0x72>
  }
  int mask = atoi(argv[1]);
  82:	00000097          	auipc	ra,0x0
  86:	208080e7          	jalr	520(ra) # 28a <atoi>
  if (trace(mask) < 0) {
  8a:	00000097          	auipc	ra,0x0
  8e:	3a0080e7          	jalr	928(ra) # 42a <trace>
  92:	04054663          	bltz	a0,de <main+0xde>
    fprintf(2, "trace failed\n");
    exit(1);
  }
  exec(command[0], command);
  96:	ef040593          	addi	a1,s0,-272
  9a:	ef043503          	ld	a0,-272(s0)
  9e:	00000097          	auipc	ra,0x0
  a2:	324080e7          	jalr	804(ra) # 3c2 <exec>
  exit(0);
  a6:	4501                	li	a0,0
  a8:	00000097          	auipc	ra,0x0
  ac:	2e2080e7          	jalr	738(ra) # 38a <exit>
    fprintf(2, "Usage: strace <mask> <command>\n");
  b0:	00001597          	auipc	a1,0x1
  b4:	82058593          	addi	a1,a1,-2016 # 8d0 <malloc+0xe8>
  b8:	4509                	li	a0,2
  ba:	00000097          	auipc	ra,0x0
  be:	642080e7          	jalr	1602(ra) # 6fc <fprintf>
    fprintf(2, "The mask must be a number\n");
  c2:	00001597          	auipc	a1,0x1
  c6:	82e58593          	addi	a1,a1,-2002 # 8f0 <malloc+0x108>
  ca:	4509                	li	a0,2
  cc:	00000097          	auipc	ra,0x0
  d0:	630080e7          	jalr	1584(ra) # 6fc <fprintf>
    exit(1);
  d4:	4505                	li	a0,1
  d6:	00000097          	auipc	ra,0x0
  da:	2b4080e7          	jalr	692(ra) # 38a <exit>
    fprintf(2, "trace failed\n");
  de:	00001597          	auipc	a1,0x1
  e2:	83258593          	addi	a1,a1,-1998 # 910 <malloc+0x128>
  e6:	4509                	li	a0,2
  e8:	00000097          	auipc	ra,0x0
  ec:	614080e7          	jalr	1556(ra) # 6fc <fprintf>
    exit(1);
  f0:	4505                	li	a0,1
  f2:	00000097          	auipc	ra,0x0
  f6:	298080e7          	jalr	664(ra) # 38a <exit>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 49a:	49250513          	addi	a0,a0,1170 # 928 <digits>
 49e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 566:	3c6b8b93          	addi	s7,s7,966 # 928 <digits>
 ...
 6a6:	27e90913          	addi	s2,s2,638 # 920 <malloc+0x138>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 8c0:	b56080e7          	jalr	-1194(ra) # 412 <sbrk>
  if(p == (char*)-1)
